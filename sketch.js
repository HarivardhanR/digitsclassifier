...
function preload() {
  // Loading data.
  traindigitsData = loadBytes('Data/TenThousand_TrainDigits.bin');
  trainlabelsData = loadStrings('Data/TenThousandTrainData.txt');
  testdigitsData = loadBytes('Data/Thousand_TestDigits.bin');
  testlabelsData = loadStrings('Data/ThousandTestData.txt');
}
